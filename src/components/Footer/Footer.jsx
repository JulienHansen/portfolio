...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/kassandra-quarto-a58a80355/',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/kassandra_quarto/',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/profile.php?id=100008148278099',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
